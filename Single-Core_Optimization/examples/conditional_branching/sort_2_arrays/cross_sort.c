...
int main(int argc, char **argv)
{
  ...
  if ( (Ac = (int*)aligned_alloc(sizeof(int), SIZE*sizeof(int))) == NULL )
    {
      printf ( "not enough memory (%llu GB) to allocate %u elements\n",
	       (unsigned long long int)SIZE*sizeof(int), SIZE);
      exit( 1 );
    }
  if ( (A = (int*)aligned_alloc(sizeof(int), SIZE*sizeof(int))) == NULL )
    {
      printf ( "not enough memory (%llu GB) to allocate %u elements\n",
	       (unsigned long long int)SIZE*sizeof(int), SIZE);
      exit( 1 );
    }
  if ( (Bc = (int*)aligned_alloc(sizeof(int), SIZE*sizeof(int))) == NULL )
    {
      printf ( "not enough memory (%llu GB) to allocate %u elements\n",
	       (unsigned long long int)SIZE*sizeof(int), SIZE);
      exit( 1 );
    }
  if ( (B = (int*)aligned_alloc(sizeof(int), SIZE*sizeof(int))) == NULL )
    {
      printf ( "not enough memory (%llu GB) to allocate %u elements\n",
	       (unsigned long long int)SIZE*sizeof(int), SIZE);
      exit( 1 );
